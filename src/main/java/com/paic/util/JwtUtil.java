...
public class JwtUtil {
    ...
    private static final String defaultbase64EncodedSecretKey = "shiro-framework";
    private static final String defaultiss = "GBD";
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        JwtUtil util = new JwtUtil(defaultbase64EncodedSecretKey, SignatureAlgorithm.HS256);
        //以tom作为秘钥，以HS256加密
        ...
        String jwtToken = util.encode(defaultiss, 300000, map);

        System.out.println(jwtToken);
        Claims claims = util.decode(jwtToken);
        ...
        UserAuth bean = new UserAuth();
        BeanUtils.populate(bean, map);
        System.out.println(JSON.toJSONString(bean));
    }

    public String encode(int i, Map<String, Object> claims) {
        return encode(defaultiss, i, claims);
    }
